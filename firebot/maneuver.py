...
class Manuever:
    def __init__(self,fl_1:int,fl_2:int,fr_1:int,fr_2:int,bl_1:int,bl_2:int,br_1:int,br_2:int,fr_e:int,fl_e:int,bl_e:int,br_e:int):
        self.fl_1 = fl_1
        self.fl_2 = fl_2
        self.fr_1 = fr_1
        self.fr_2 = fr_2
    ...
    def foward(self):
        ...
        GPIO.output(sefl.bl_1 , GPIO.HIGH)
    ...
    def backward(self):
        ...
        GPIO.output(sefl.bl_2 , GPIO.HIGH)
    ...
    def slide_right(self):
        ...
        GPIO.output(self.fr_1 , GPIO.LOW)
        GPIO.output(self.fr_2 , GPIO.HIGH)
        GPIO.output(sefl.bl_1 , GPIO.LOW)
